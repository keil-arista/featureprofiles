...
type Metadata_Deviations struct {
	...
	CoppL2UnicastUnsupported bool `protobuf:"varint,415,opt,name=copp_l2_unicast_unsupported,json=coppL2UnicastUnsupported,proto3" json:"copp_l2_unicast_unsupported,omitempty"`
	// Vendor-specific COPP platform path element (e.g. "sand", "strata").
	// Defaults to "sand" when empty.
	CoppPlatformPath string `protobuf:"bytes,416,opt,name=copp_platform_path,json=coppPlatformPath,proto3" json:"copp_platform_path,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetCoppPlatformPath() string {
	if x != nil {
		return x.CoppPlatformPath
	}
	return ""
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf0\xe6\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xbc\xdc\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x12macsec_counters_ft\x18\x9e\x03 \x01(\tR\x10macsecCountersFt\x12>\n" +
	"\x1bcopp_l2_unicast_unsupported\x18\x9f\x03 \x01(\bR\x18coppL2UnicastUnsupported\x12-\n" +
	"\x12copp_platform_path\x18\xa0\x03 \x01(\tR\x10coppPlatformPathJ\x04\bT\x10UJ\x04\b\t\x10\n" +
